...
mfe.cli.run = (argv)->
    ...
    program
        .command('ad <name>')
        .description('[add deploy] 添加明为name的部署标识')
        .action (name, cmd)->
    ...
    program
        .command('rd <name>')
        .description('[remove deploy] 删除部署标识')
        .action (name, cmd)->
    ...
    program
        .command('ed <name>')
        .description('[edit deploy] 编辑部署标识')
        .action (name, cmd)->
    ...
    program
        ...
        .description('[list deploy] 列出全部部署标识')
        .action (cmd)->
    ...
    program
        .command('dp <project>')
        .option('-d, --deploy <name>', '部署标识')
        .description('[deploy project] 部署整个工程')
        .action (name, cmd)->
